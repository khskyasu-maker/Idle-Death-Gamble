...
- 최신 집계표는 `python scripts/publish_sim_results.py`로 재생성합니다. 기본값은 10,000/15,000/20,000엔, 각 조건 5,000회, 행별 고정 seed입니다.
...
- 회전율 민감도 요약은 실제 결과나 현장 기록이 아니라, 보더 기준 또는 60/70/80/90회 조건에서 입력 회전수가 달라질 때 P50 체류, 플러스율, 완전소진률, 중앙손익이 얼마나 흔들리는지 보는 사전 분석입니다.
